...
import com.cg.model.dto.CustomerReqUpBDTO;
...
public class CustomerResController {
    ...
    public ResponseEntity<?> update(@Validated @RequestBody CustomerCreReqDTO customerCreReqDTO,@PathVariable Long customerId, BindingResult bindingResult) {
        ...
        Customer customerOld = customerService.findById(customerId).get();
        Customer customer = customerCreReqDTO.toCustomer();
        customer.setId(customerId);
        customer.setBalance(customerOld.getBalance());
        customer.setDeleted(customerOld.getDeleted());
        customer.getLocationRegion().setId(customerOld.getLocationRegion().getId());
        customerService.update(customer);

        return new ResponseEntity<>(customer, HttpStatus.OK);
    }
    @GetMapping("/ban")
    public ResponseEntity<?> getBanALl() {
